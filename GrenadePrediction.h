...
public:
	...
	CColor TracerColor = CColor(Clientvariables->Visuals.cNadePrediction[0] * 255, Clientvariables->Visuals.cNadePrediction[1] * 255, Clientvariables->Visuals.cNadePrediction[2] * 255, 255);
