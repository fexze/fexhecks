...
public:
	void DrawSetTexture(int id)
	{
		...
		return ((Fn)GetFunction<Fn>(this, 38))(this, id);
	}

	void DrawSetTextureRGBA(int id, const unsigned char const* rgba, int wide, int tall)
	{
		typedef void(__thiscall* Fn)(void*, int, const unsigned char const*, int, int, int, bool);
		return ((Fn)GetFunction<Fn>(this, 37))(this, id, rgba, wide, tall, 0, false);
	}
	...
	void DrawTexturedPolygon(int n, Vertex_t* pVertice, bool bClipVertices = true)
	{
		...
		return ((Fn)GetFunction<Fn>(this, 106))(this, n, pVertice, bClipVertices);
	}

	void DrawSetColor(CColor col)
	{
		typedef void(__thiscall* Fn)(void*, CColor);
		return ((Fn)GetFunction<Fn>(this, 14))(this, col);
	}

	void SetDrawColor(Color color)
	{
		SetDrawColor(color.red, color.green, color.blue, color.alpha);
	}

	int CreateNewTextureID(bool procedural = false)
	{
		typedef int(__thiscall* Fn)(void*, bool);
		return ((Fn)GetFunction<Fn>(this, 43))(this, procedural);
	}

	void SetDrawColor(int r, int g, int b, int a)
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return ((Fn)GetFunction<Fn>(this, 15))(this, r, g, b, a);
	}

	void SetDrawColor(CColor color)
	{
		typedef void(__thiscall* Fn)(void*, CColor);
		return ((Fn)GetFunction<Fn>(this, 14))(this, color);
	}

	void DrawFilledRect(int x, int y, int x2, int y2)
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return ((Fn)GetFunction<Fn>(this, 16))(this, x, y, x2, y2);
	}

	void DrawOutlinedRect(int x, int y, int x2, int y2)
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return (GetFunction<Fn>(this, 18))(this, x, y, x2, y2);
	}
	...
	bool GetTextSize(int Font, const wchar_t* _Input, int& Wide, int& Tall)
	{
		...
		return ((Fn)GetFunction<Fn>(this, 79))(this, Font, _Input, Wide, Tall);
	}

	void DrawLine(int x, int y, int x2, int y2)
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return ((Fn)GetFunction<Fn>(this, 19))(this, x, y, x2, y2);
	}

	void DrawPolyLine(int* px, int* py, int numPoints)
	{
		typedef void(__thiscall* Fn)(void*, int*, int*, int);
		return ((Fn)GetFunction<Fn>(this, 20))(this, px, py, numPoints);
	}

	void DrawOutlinedCircle(int x, int y, int radius, int segments)
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return ((Fn)GetFunction<Fn>(this, 103))(this, x, y, radius, segments);
	}

	unsigned long SCreateFont()
	{
		typedef unsigned int(__thiscall* OriginalFn)(PVOID);
		return GetFunction< OriginalFn >(this, 71)(this);
	}

	void SetFontGlyphSet(unsigned long& font, const char* windowsFontName, int tall, int weight, int blur, int scanlines, int flags)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, unsigned long, const char*, int, int, int, int, int, int, int);
		GetFunction< OriginalFn >(this, 72)(this, font, windowsFontName, tall, weight, blur, scanlines, flags, 0, 0);
	}

	void DrawSetTextFont(unsigned int Font)
	{
		typedef void(__thiscall* Fn)(void*, unsigned int);
		return ((Fn)GetFunction<Fn>(this, 23))(this, Font);
	}

	void DrawSetTextColor(int r, int g, int b, int a)
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return ((Fn)GetFunction<Fn>(this, 25))(this, r, g, b, a);
	}

	void DrawSetTextPos(int x, int y)
	{
		typedef void(__thiscall* Fn)(void*, int, int);
		return ((Fn)GetFunction<Fn>(this, 26))(this, x, y);
	}

	void DrawPrintText(const wchar_t* Text, int Len, int DrawType = 0)
	{
		typedef void(__thiscall* Fn)(void*, wchar_t const*, int, int);
		return ((Fn)GetFunction<Fn>(this, 28))(this, Text, Len, DrawType);
	}

	void DrawSetTextColor(CColor Color)
	{
		typedef void(__thiscall* Fn)(void*, CColor);
		return ((Fn)GetFunction<Fn>(this, 24))(this, Color);
	}

	void DrawFilledRectArray(IntRect* rects, int rect_amount)
	{
		typedef void(__thiscall *Fn)(void*, IntRect*, int);
		return GetFunction<Fn>(this, 17)(this, rects, rect_amount);
	}

	void DrawTexturedRect(int x0, int y0, int x1, int y1)
	{
		typedef void(__thiscall *Fn)(void*, int, int, int, int);
		GetFunction<Fn>(this, 40)(this, x0, y0, x1, y1);
	}

	void IPlaySound(const char* fileName)
	{
		typedef void(__thiscall* OriginalFn)(void*, const char*);
		return GetFunction<OriginalFn>(this, 82)(this, fileName);
	}
