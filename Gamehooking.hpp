...
/* SendNetMsg defs */
typedef bool(__thiscall* SendNetMsg_t)(INetChannel*, INetMessage&, bool, bool);
extern SendNetMsg_t o_SendNetMsg;
...
namespace Handlers
{
	...
	bool __fastcall SendNetMsg_h(INetChannel* pNetChan, void* edx, INetMessage& msg, bool bForceReliable, bool bVoice);
