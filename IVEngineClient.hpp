...
public:
	void* operator new(size_t iAllocSize)
	{
		...
		return VT::vfunc<oAllocKeyValuesMemory>(pKeyValuesSystem, 1)(pKeyValuesSystem, iAllocSize);
	}
	...
	void operator delete(void* pMem)
	{
		...
		VT::vfunc<oFreeKeyValuesMemory>(pKeyValuesSystem, 2)(pKeyValuesSystem, pMem);
	}
