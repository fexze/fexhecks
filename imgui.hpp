...
namespace ImGui
{
	...
	{
		ImGuiColorEditFlags_Alpha = 1 << 0,
		ImGuiColorEditFlags_RGB = 1 << 1,
		ImGuiColorEditFlags_HSV = 1 << 2,
		ImGuiColorEditFlags_HEX = 1 << 3,
		ImGuiColorEditFlags_NoPicker = 1 << 4,
		ImGuiColorEditFlags_NoOptions = 1 << 5,
		ImGuiColorEditFlags_NoColorSquare = 1 << 6,
		ImGuiColorEditFlags_NoSliders = 1 << 7,
	...
	IMGUI_API bool          MyColorEdit3(const char* label, float col[3], ImGuiColorEditFlags flags = 0);
	bool                    ColorButton(const ImVec4 & col, bool small_height, bool outline_border);
	IMGUI_API bool			MyColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags = 0x01);
	IMGUI_API bool          ColorButton2(const ImVec4& col, bool small_height = false, bool outline_border = true);
...
enum ImGuiCol_
{
	...
	ImGuiCol_RadioButtonDot,
	ImGuiCol_RadioButtonBg,
	ImGuiCol_RadioButtonActive,
	ImGuiCol_RadioButtonHovered,
	ImGuiCol_COUNT
};
